...
export interface FrontendLabFixtureApi {
  readonly frontendLabFixture: FrontendLabFixture;
  readonly frontendLabTasks: readonly FrontendLabTask[];
  readonly parseFrontendLabFixture: (value: unknown) => FrontendLabFixture;
  readonly parseFrontendLabTasks: (value: unknown) => readonly FrontendLabTask[];
  readonly createFrontendLabReport: (taskIds?: readonly string[]) => Readonly<{ version: 1; tasks: readonly FrontendLabReportTask[] }>;
}
...
declare global {
  const StensiblyFrontendLabFixtures: FrontendLabFixtureApi;
}
