...
export const frontendLabFixture = parseFrontendLabFixture(sourceFixture);
export const frontendLabTasks = parseFrontendLabTasks(sourceTasks);

export function parseFrontendLabFixture(value) {
...
export function parseFrontendLabTasks(value) {
...
export function createFrontendLabReport(taskIds = frontendLabTasks.map((task) => task.id)) {
