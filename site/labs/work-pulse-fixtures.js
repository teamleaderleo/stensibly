...
function digest(value, label) { const normalized = text(value, 71, label); if (!/^sha256:[a-f0-9]{64}$/u.test(normalized)) throw new TypeError(`${label} is invalid`); return normalized; }
