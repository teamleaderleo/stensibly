...
function snapshotCompileProjectBriefInput(
  ...
  const project = dataProperty(value, "project", "Project brief compile input") as string;
  const generatedAt = dataProperty(
    value,
    "generatedAt",
  ...
  const limit = optionalDataProperty(
    value,
    "limit",
    "Project brief compile input",
  ) as number | undefined;
...
function snapshotProjectBriefItem(value: unknown): ProjectBriefItemInput {
  ...
  return {
    id: dataProperty(value, "id", "Project brief item") as string,
    project: dataProperty(value, "project", "Project brief item") as string,
    kind: dataProperty(value, "kind", "Project brief item") as ItemKind,
    title: dataProperty(value, "title", "Project brief item") as string,
    summary: dataProperty(value, "summary", "Project brief item") as string | null,
    status: dataProperty(value, "status", "Project brief item") as ItemStatus,
    priority: dataProperty(value, "priority", "Project brief item") as number,
    nextAction: dataProperty(
      value,
      "nextAction",
      "Project brief item",
    ) as string | null,
    claimedBy: dataProperty(
      value,
      "claimedBy",
      "Project brief item",
    ) as string | null,
    claimExpiresAt: dataProperty(
      value,
      "claimExpiresAt",
      "Project brief item",
    ) as string | null,
    updatedAt: dataProperty(value, "updatedAt", "Project brief item") as string,
  };
}
...
function snapshotProjectBriefArtifact(
  ...
  return {
    project: dataProperty(value, "project", "Project brief artifact") as string,
    id: dataProperty(value, "id", "Project brief artifact") as string,
    itemId: dataProperty(value, "itemId", "Project brief artifact") as string,
    itemTitle: dataProperty(
      value,
      "itemTitle",
      "Project brief artifact",
    ) as string,
    actorId: dataProperty(value, "actorId", "Project brief artifact") as string,
    kind: dataProperty(value, "kind", "Project brief artifact") as ArtifactKind,
    label: dataProperty(value, "label", "Project brief artifact") as string,
    uri: dataProperty(value, "uri", "Project brief artifact") as string,
    createdAt: dataProperty(
      value,
      "createdAt",
      "Project brief artifact",
    ) as string,
