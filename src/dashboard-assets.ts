...
export const dashboardAssets: readonly DashboardAssetExpectation[] = [
  ...
  { path: "/project-attachment-draft-entry.js", kind: "javascript", contentTypes: javascriptContentTypes, marker: "installProjectAttachmentDraftAction" },
  ...
  { path: "/project-correspondence-controller.js", kind: "javascript", contentTypes: javascriptContentTypes, marker: "installProjectCorrespondenceController" },
  { path: "/project-correspondence.js", kind: "javascript", contentTypes: javascriptContentTypes, marker: "readProjectCorrespondence" },
  { path: "/project-correspondence.css", kind: "css", contentTypes: cssContentTypes, marker: ".project-correspondence-dialog" },
  { path: "/project-activity-controller.js", kind: "javascript", contentTypes: javascriptContentTypes, marker: "installProjectActivityController" },
  { path: "/project-activity.js", kind: "javascript", contentTypes: javascriptContentTypes, marker: "readProjectActivity" },
  { path: "/project-activity.css", kind: "css", contentTypes: cssContentTypes, marker: ".project-activity-dialog" },
