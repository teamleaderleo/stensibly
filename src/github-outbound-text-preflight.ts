...
function detectReferences(text: string): readonly DetectedReference[] {
  ...
  const repositoryShorthandPattern =
    /(?:^|[^A-Za-z0-9._~:/?#@!$&*+,;=%-])([A-Za-z0-9][A-Za-z0-9-]{0,38})\/([A-Za-z0-9][A-Za-z0-9_.-]{0,99})#([1-9][0-9]*)(?![A-Za-z0-9._~\/?#@!$&*+=%-])/gu;
  const commitShorthandPattern =
    /(?:^|[^A-Za-z0-9._~:/?#@!$&*+,;=%-])([A-Za-z0-9][A-Za-z0-9-]{0,38})\/([A-Za-z0-9][A-Za-z0-9_.-]{0,99})@([0-9a-f]{7,64})(?![A-Za-z0-9._~\/?#@!$&*+=%-])/giu;
