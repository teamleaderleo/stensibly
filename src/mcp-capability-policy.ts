...
const policyInputs: readonly McpCapabilityPolicyInput[] = [
  ...
  readPolicy("get_github_project_context", directProject),
  ...
  writePolicy("github_add_issue_assignees", directProject),
  writePolicy("github_add_issue_comment", directProject),
  writePolicy("github_add_issue_labels", directProject),
  writePolicy("github_create_issue", directProject),
  writePolicy("github_remove_issue_assignees", directProject),
  writePolicy("github_remove_issue_label", directProject),
