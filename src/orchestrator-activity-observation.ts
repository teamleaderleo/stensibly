...
export const ORCHESTRATOR_ACTIVITY_SOURCE_CLASSES = Object.freeze([
  "ledger_event",
  "responsibility",
  "provider_receipt",
  "ci_receipt",
...
export const ORCHESTRATOR_ACTIVITY_CLASSES = Object.freeze([
  "work_started",
  "progress_evidence",
  "provider_effect",
  "verification",
...
export const ORCHESTRATOR_ACTIVITY_STATES = Object.freeze([
  "observed",
  "in_progress",
  "succeeded",
  "failed",
...
export const ORCHESTRATOR_PROVIDER_LIFECYCLES = Object.freeze([
  "reserved",
  "dispatched",
  "accepted",
  "verified",
...
export const ORCHESTRATOR_ATTENTION_LEVELS = Object.freeze([
  "none",
  "review",
  "decision",
  "incident",
