/**
 * Returns the lowercase hexadecimal SHA-256 digest for exact UTF-8 text.
 *
 * This deliberately avoids Node-only crypto APIs so deterministic identity
 * code can run in Bun, workerd, browsers, and the default Convex runtime.
 */
