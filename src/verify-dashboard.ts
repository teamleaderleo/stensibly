...
export function verifyDashboardHtml(html: string): void {
  const required = [
    ...
    'content="Stensibly is the live control surface for work moving across people, agents, providers, and deployments."',
    'content="https://www.stensibly.com/studio-control-social.png"',
    ...
    'href="/studio-control.css"',
    'id="github-sign-in"',
    'id="connect-form"',
    'id="dashboard"',
    'data-dashboard-view-panel="overview"',
    'id="focus-list"',
    'data-dashboard-view-panel="work"',
    'data-dashboard-view-panel="system"',
