...
const adapterId = "descriptor-snapshot-adapter";
const adapterVersion = "1.0.0";
const profileId = "descriptor-snapshot-profile";
const runId = "run-descriptor-snapshot";
...
function command(): RunnerCancellationCommandV1 {
  return {
    ...
    commandId: "cancel-descriptor-snapshot",
    adapterId,
    adapterVersion,
    profileId,
    runId,
    ...
    authority: {
      resource: `run:${runId}`,
      holderId: "actor-descriptor-snapshot",
      generation: 2,
      expiresAt: "2026-08-01T03:00:00.000Z",
    },
    requestedAt,
    reason: "Exercise descriptor snapshot admission.",
  };
}
...
function evidence(
  ...
  return {
    version: 1,
    reconciliationId: "reconcile-descriptor-snapshot-1",
